...
public class Data {
        ...
        static public String[] symptoms = {
                ...
                "Pain, Reddening of the skin, Swelling",//1st Degree Burns
                "Red-white skin, Blisters, Pain, Swelling",//2nd Degree Burns
                "White and blackened, Charred skin, Sometimes numb, Raised and leathery",//3rd Degree Burns
                ...
                "A headache, Heart attack, Muscle twitches, Seizure, Shortness of breath, Dizziness",//Chemical Burns Swallowed
                "Bleeding, Pain, Swelling, Open skin",//Cuts and Wounds - MINOR
                "Bleeding, Pain, Numbness(depends on where located), Swelling, Open skin",//Cuts and Wounds - MAJOR
                "The victim struggles to put their head above water and later submerged under the water",//Drowning
                "Wounds or burns on skin, Headache and dizziness, Fast heartbeat, Shortness of breathe, pain all over the body, weakness and muscle pains",//Electric Burns
                ...
                "Overwhelming pain in tooth and gums, Swollen gums",//Toothache
                "",//Pulse
                "",//Pulse
                "",//Recovery position
                "",//CPR - ADULT
        ...
        static public String[] firstAid = {
                ...
                "Hold the burn under cool water for 10 to 20 minutes,Remove tight clothing or ring around burnt area,Do not break blisters,Apply aloe vera gel or lotion to ease pain,Take some over the counter painkillers (paracetamol)",//1st Burns
                "Run skin under cool water for 15 minutes or longer, Take over the counter pain medication, Apply antibiotic cream/dust on blisters, Bandage lightly to reduce infections",//2nd Burns
                "Call the emergency medical team, Raise the injury above the heart, Don’t remove clothing.,Check clothing if stuck on the burn then remove.",//3rd Burns
                ...
                "Low supply of power  e.g. domestic usage: Switch off the power and remove the causality from the source with a non-conductive material (wood). If the causality is unconscious conduct CPR, High supply of power - Call emergency medical unit",//Electric Burns
                ...
                "Hold and take deep breathes by counting 1-10,Drink a glass of water completely without prose,Put a spoonful of sugar or honey on the tongue,If the hiccups persist contact a medical doctor",//Hiccups
                ...
                "Call Emergency medical unit, Ask if the person if is carrying an epinephrine injector,Keep the person calm warm and loosen tight clothing,If the person is vomiting turn them to the side (recovery position), If the person is unconscious begin CPR until help arrives",//Attention for Stings
                ...
                "Rinse mouth with warm water,Floss to remove food particles,Apply a cold compressing on the outside of mouth or cheek(use cloth stacked with ice),Give painkillers such as ibuprofen to reduce pain,Give aspirin to persons above 18 years,If pain persists see a doctor",//Toothache
        ...
        static public String[] notes = {
                ...
                "NOTE: Call emergency medical unit if the burn occurs on joints, face, feet and buttocks",//1st Burns
                "NOTE: Call emergency medical unit if the burn occurs on joints, face, feet and buttocks",//2nd Burns
                "NOTE: Call emergency medical unit immediately when the person has a:Lower immune system,Pregnant,Other injuries needing treating,Over 60 years of age,Under five years of age,Other medical conditions such as diabetes, heart, kidney, liver",//3rd Burns
                ...
                "DO NOT put aspirin on the gum of aching tooth it can burn tissue",//Toothache
                "Do not use the thumb,Use the middle and the index finger",//Pulse - Radial
                "Do not use the thumb,Use the middle and the index finger",//Pulse - Carotid
                "",
                "",//CPR - ADULT
                "",//CPR - CHILD
                "",//Abdominal Thrust
