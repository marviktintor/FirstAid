...
public class Data {
    ...
    String [] firstAid = {
            ...
            "LOW SUPPLY OF POWER, e.g., domestic usage,Switch off the power,Remove the causality from the source with non-conductive material (wood),If the causality is unconscious conduct CPR,HIGH SUPPLY OF POWER,Call emergency medical unit",//Electric Burns
    ...
    String [] notes = {
            ...
            "Do not use the thumb,Use the middle and the index finger,Radial pulse (inside the wrist),Stretch the arm and place the pads of the two fingers at the base of the thumb,Press lightly and move fingers until you feel a pulse,Carotid pulse (on the neck),Place the pads of the middle and index finger between the windpipe and the large muscles of the neck,Press lightly until you feel a pulse",//Pulse
            "",//CPR - ADULT
            "",//CPR - CHILD
    };
